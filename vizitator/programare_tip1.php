...
<h2>Programul vizitelor: vineri si sambata intre orele 9:00-10:30 si 14:00-15:00</h2><br>
...
echo $_SESSION['id_institutie'];
  ...
  <span>$i</span>
  <div class=\"dropdown-content\">
    <p>Ziua aleasa este nu este disponibila!</p>
  </div>
</div>"; // Zilele din interiorul calendarului
     echo " </td>";
...
<div align="center">
   ...
   <p><form  method="post" action="#openModal2">
<div>
...
<div class="input-validation"></div>
 ...
 <select name="type">
  ...
  <option value="12:00-12:30">10:00-10:45</option>
  <option value="12:30-13:00">10:45-11:30</option>
   <option value="13:00-13:30">11:30-12:15</option>
  <option value="13:30-14:00">12:15-13:00</option>
   <option value="14:00-14:30">13:00-13:45</option>
  <option value="14:30-15:00<">13:45-14:30</option>
   <option value="15:00-15:30">14:30-15:15</option>
  <option value="15:30-16:00">15:15-16:00</option>
...
$sql3="SELECT * FROM (SELECT ID_PROGRAMARE1 FROM programare_vizita_tip1  WHERE ROWNUM <= (select count(*) from programare_vizita_tip1 ) ORDER BY ROWNUM DESC) WHERE ROWNUM < 2";
...
$conn = oci_connect("Student","STUDENT", "localhost");
   ...
   if (!$conn)  {
    ...
    if (!empty($_POST['nume']) AND !empty($_POST['prenume']) AND !empty($_POST['email'])  AND !empty($_POST['type']))
...
if (!$stmt4) 
        ...
        $sql ="INSERT INTO programare_vizita_tip1 VALUES (:bind1, :bind2, :bind3, :bind4, :bind5 ,:bind6,:bind8, :bind9)";
...
<div>
    <a href="#close" title="Close" class="close">X</a>
    <h2>Programare online</h2><br><br>
    <h3 align="center">Va multumim!</h3><br>
    <p><strong>Programarea a fost realizata cu succes!</strong></p>
